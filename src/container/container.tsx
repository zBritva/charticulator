...
export interface ChartContainerComponentProps {
  ...
  onMouseContextMenuClickGlyph?: (data: { table: string; rowIndices: number[] }, modifiers: any) => void;
}
...
> {
  ...
  protected handleGlyphContextMenuClick: GlyphEventHandler = (data, modifiers) => {
...
export class ChartContainer extends EventEmitter {
  ...
  public addContextMenuListener(
    listener: (table: string, rowIndices: number[], clientX: number, clientY: number) => void
  ): EventSubscription {
